...
const dependencies = {
  ...
  "@strapi/icons": "1.14.1",
  "@strapi/provider-upload-local": "4.20.1",
  "@strapi/utils": "4.20.1",
  axios: "1.6.0",
  "byte-size": "7.0.1",
  cropperjs: "1.6.0",
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-24kq33Ex.js"));
        return component;
      }
    });
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-0OVxOrGs.js"));
        return component;
      },
...
//# sourceMappingURL=index-BfGsUmxn.js.map
