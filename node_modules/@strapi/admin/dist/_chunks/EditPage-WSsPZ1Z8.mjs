...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-4xPDm1sd.mjs";
...
import { u as useWebhooks } from "./useWebhooks-_teNEb-d.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-hwwD5TyQ.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-WSsPZ1Z8.mjs.map
