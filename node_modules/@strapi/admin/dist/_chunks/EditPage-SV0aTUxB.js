...
const useWebhooks = require("./useWebhooks-Q3t4mJdN.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-O66id4Eg.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-SV0aTUxB.js.map
