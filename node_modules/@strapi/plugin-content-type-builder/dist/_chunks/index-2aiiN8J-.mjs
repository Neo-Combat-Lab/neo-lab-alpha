...
const ListView$1 = lazy(() => import("./ListView-NULLmOvG.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-NULLmOvG.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-2aiiN8J-.mjs.map
