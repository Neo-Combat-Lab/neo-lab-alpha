...
const index$1 = require("./index-lAvDOVx_.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-1IN-G1FI.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-1IN-G1FI.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-rKfE16ca.js.map
